...
import {SiJavascript,SiNodedotjs,SiReact,SiHtml5,SiCss3,SiBootstrap,SiMongodb,SiExpress, SiMysql, SiFirebase, SiPython, SiSass, SiJava, SiPostman, SiNodemon, SiGithub, SiC, SiFigma} from 'react-icons/si'
function Skills() {
  return (
    <Fragment>
        <div className="col py-3 d-flex align-items-center"> 
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div>
                            <h1 className="font-big text-red slide-in-top">Coding Languages</h1>
                            <hr></hr>

                            <div className="row my-2">

                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                    <span><SiC className='fs-4'/> </span>
                                </div>
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                        ...
                        <div>
                            ...
                            <div className="row my-2">
                            <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                    <span><SiGithub className='fs-4'/> Version Control</span>
                                </div>
                            <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                            ...
                            <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                ...
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                    <span><SiSass className='fs-4'/>Sass</span>
                                </div>
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                    <span><SiBootstrap className='fs-4'/> Bootstrap</span>
                                </div>
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                    <span><SiNodedotjs className='fs-4'/> Node</span>
                                </div>
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                    <span><SiNodemon className='fs-4'/> Nodemon</span>
                                </div>
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                ...
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                    <span><SiFirebase className='fs-4'/> FireBase</span>
                                </div>
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                    <span><SiFigma className='fs-4'/> Figma</span>
                                </div>
                                <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
